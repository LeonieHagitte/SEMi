...
{{Reliability}_i}.
$$
The residual variances $\theta_{i0}$ are fixed at these baseline values across moderator values and population models. 
Consequently, when factor loadings are moderated, reliability may vary as a function of the moderator. 
