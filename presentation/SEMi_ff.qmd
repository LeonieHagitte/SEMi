...
- Most datasets follow the expected sequential decision process.
- Early detection of metric noninvariance precludes scalar-tree estimation.
- Consequently, scalar-tree results should be interpreted as conditional on metric invariance.
