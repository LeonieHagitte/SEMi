...
- The SEM Tree directly tests instability in the item intercept parameters (nu_1, ..., nu_4).
...
- Such a common shift in observed item means can potentially be represented by a moderator-dependent latent factor mean.
- This is particularly relevant because the baseline loadings are equal (λ = .70), making a common latent-mean shift capable of producing similar mean shifts across all indicators.
