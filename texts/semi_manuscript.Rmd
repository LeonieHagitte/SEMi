...
Structural equation models (SEMs) are widely used to define latent constructs and their relations to observed indicators [CITATION NEEDED]. 
...
From this perspective, categorizing individuals into predefined groups may obscure important variation in the mechanisms underlying psychological constructs. [AB->LH: Dieser Satz ist gedoppelt zum vorherigen Absatz]
