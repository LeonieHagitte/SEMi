...
take. The researcher decision structure of this approach remains closely
aligned with familiar MGCFA practice, making SEM trees a comparatively
accessible extension of conventional MI analysis.
...
and categorical partitioning variables, and potentially nonlinear forms
of heterogeneity, given the sample size is large enough to detect such
...
available, SEM trees could provide a complementary strategy for
situations in which the sources or functional forms of heterogeneity are
uncertain.
