...
parameter--covariate relationship is linear, quadratic, or sigmoid,
...
(Bauer et al. 2020; Belzak and Bauer 2024). Although such extensions can
...
of Health, Ageing and Retirement in Europe (SHARE-ERIC 2024). The
CASP-12 is a shortened version of the original 19-item CASP scale; the
version used in SHARE also differs slightly from the CASP-12 proposed by
Wiggins et al. (2008, 2008; Borrat-Besson et al. 2015).

The application is motivated by Bonneville-Roussy et al. (2024), who
investigated longitudinal and cross-sectional MI of the CASP-12 across
age, gender, and cultural regions using group-based comparisons. Here,
we focus on cross-sectional MI in wave 9, using age, gender, and culture
as covariates. In particular, age provides a useful case for comparing
conventional MGCFA, which requires discretization into age groups, with
approaches that can incorporate age as a continuous covariate and
thereby avoid potentially arbitrary categorization.
